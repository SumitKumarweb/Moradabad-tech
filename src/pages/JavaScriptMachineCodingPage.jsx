...
import { getAllJavaScriptMachineCodingQuestions, getTotalJavaScriptMachineCodingQuestions } from "@/lib/javascriptMachineCoding"
...
export default function JavaScriptMachineCodingPage() {
  const totalQuestions = getTotalJavaScriptMachineCodingQuestions()
  ...
  const breadcrumbItems = [
    ...
    { name: "JavaScript Machine Coding", url: typeof window !== 'undefined' ? window.location.href : '' }
  ]

  return (
    <>
      <SEO
        title="JavaScript Machine Coding Round"
        description={`Master JavaScript with ${totalQuestions}+ machine coding problems. From basic functions to advanced algorithms - practice building real-world JavaScript applications.`}
        keywords="JavaScript machine coding, JavaScript coding round, JavaScript functions, JavaScript algorithms, JavaScript interview questions, JavaScript practice problems, JavaScript coding challenges, vanilla JavaScript"
        ogTitle="JavaScript Machine Coding Round - Master JavaScript Development"
        ogDescription={`Practice ${totalQuestions}+ JavaScript machine coding problems from basic to advanced level.`}
        ...
        <div className="container relative mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-12 max-w-7xl">
          <Breadcrumb className="mb-4 md:mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>JavaScript Machine Coding</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          <div className="flex flex-col items-start gap-4 md:gap-6 max-w-3xl mx-auto lg:mx-0">
            ...
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Master JavaScript with {totalQuestions}+ machine coding problems. 
              From basic functions to advanced algorithms - practice building real-world JavaScript applications!
            </p>
                ...
                <div className="relative p-4 md:p-6">
                  ...
                  <div className="flex flex-col gap-2">
                    <Button asChild className="w-full group/btn text-sm">
                      <Link to={`/javascript-machine-coding/${question.id}`}>
                        View Problem
